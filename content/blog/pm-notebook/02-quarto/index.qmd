...
-   [Easier verbatim
    ...
    this chunk option here (invisibly) to show a chunk where I am suppressing the results printing:
...
-   For projects like books, websites, blogs, `quarto render` vs
    ...
    [here](https://quarto.org/docs/websites/#workflow). Not sure I have advice at this point, but do read this bit:
