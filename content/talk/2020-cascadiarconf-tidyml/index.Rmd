...
draft: false
event: 'Cascadia R Conf 2020'
event_url: https://cascadiarconf.com/
location: Eugene, OR
summary: "Cascadia R Conf 2020: A 4-hour workshop to introduce the basics of machine learning in R using tidymodels."

# Talk start and end times.
#   End time can optionally be hidden by prefixing the line with `#`.
date: "2020-05-31T10:15:00Z"
date_end: "2020-05-31T16:15:00Z"
all_day: false
...
- icon: github
  icon_pack: fab
  name: materials
  url: https://github.com/rstudio-education/tidyml-cascadiarconf
...
featured: no
image:
  caption: '[Photo by David Kovalenko on Unsplash](https://unsplash.com/photos/s6nAmr5W7rI)'
  focal_point: 'center'
  preview_only: no
projects: [tidyml]
---
