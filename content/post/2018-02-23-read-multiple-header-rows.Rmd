...
{{% alert note %}}
A shorter version of this blog post now appears as an [article vignette](https://readxl.tidyverse.org/articles/articles/multiple-header-rows.html) for the `readxl` package, thank you to Jenny Bryan for the invitation!
{{% /alert %}}
