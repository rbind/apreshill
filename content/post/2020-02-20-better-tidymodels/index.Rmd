...
author: Alison Hill
summary: 'Cross-validation with tidymodels used to be sad, now it is better.'
date: '2020-02-20'
slug: better-tidymodels-cv
categories:
  - machine learning
  - tidymodels
tags:
...
subtitle: ''
authors: []
lastmod: '2020-02-20T14:29:04-08:00'
featured: no
disable_jquery: no
image:
...
penguins <- 
  read_csv(
    here::here("content/post/2020-02-20-better-tidymodels/data/penguins.csv")) %>% 
...
Things that missing: data (we haven't touched it yet) and a formula (no data, do variables). This is an *abstract* model specification. See other possible parsnip models [here](https://tidymodels.github.io/parsnip/articles/articles/Models.html).
...
We'll use the [rsample package](https://tidymodels.github.io/rsample/) split (*ayee! I promise no penguins were hurt in the writing of this blog post*) the penguins up into two datasets: training and testing. If you are unfamiliar with this practice, read up on [the holdout method](https://sebastianraschka.com/blog/2016/model-evaluation-selection-part1.html#resubstitution-validation-and-the-holdout-method).
