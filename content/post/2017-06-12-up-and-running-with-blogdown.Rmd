...
Ultimately, your [YAML front matter looks like this](https://bookdown.org/yihui/blogdown/output-format.html#output-format):
...
{{% alert note %}}
Some but not all features of `rmarkdown::html_document` [are supported in `blogdown`](https://bookdown.org/yihui/blogdown/output-format.html#fn15)
{{% /alert %}}
