...
Note that the above workflow is only for editing files, but not for **creating new posts**. For that, read on...
...
I used [Formspree](https://formspree.io) to make a contact form, which is an online service that allows you to add an HTML form to your static site. I added the following code into [my contact widget](https://github.com/apreshill/apreshill/blob/master/themes/hugo-academic/layouts/partials/widgets/contact.html):

```{r}
<form action="https://formspree.io/" method="POST">
  <label for="name">Your name: </label>
  <input type="text" name="name" required="required" placeholder="here">
