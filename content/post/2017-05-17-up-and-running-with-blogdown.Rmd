...
* Importantly, to have the `.Rmd` file include rendered R chunks, you must either run `blogdown::serve_site()` or knit your file to html first. Either way you do it, you can check that there is an `.html` file in the right directory, in addition to your `.Rmd` file.
