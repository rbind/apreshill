...
* Install `blogdown` from your RStudio console. Your working directory doesn't matter here. If you already have `devtools` installed like I did, you can just use the second line below:
...
* Still in the RStudio console, load the `blogdown` package to run the `install_hugo` function (again, your working directory doesn't matter here): 
...
* _[From Yihui & Amber's `blogdown` book:](https://bookdown.org/yihui/blogdown/rstudio-ide.html)_
* _[Also from Yihui & Amber's `blogdown` book](https://bookdown.org/yihui/blogdown/output-format.html):_ on .md versus .Rmd posts
* _[Amber's instructions](https://proquestionasker.github.io/blog/Making_Site/#adding-a-blog-post-or-portfolio-piece)_ for adding a blog post
