---
title: 'Building website castles in the clouds'
author: Alison Hill
date: '2020-12-24'
tags:
  - rmarkdown
  - distill
  - github-actions
summary: Building websites and deploying them from computers in the clouds...the easy way.
featured: no
disable_jquery: no
image:
  caption: '[Photo by Thomas Kelley on Unsplash](https://unsplash.com/photos/5YtjgRNTli4)'
  focal_point: ''
  preview_only: no
---
